...
std::string claim_boundary_check() {
    ...
    require(readme.find("Stages 12–17 remain **specifications only**") != std::string::npos,
    ...
    for (const auto& file : files) {
        ...
        const bool is_implemented = file == "Stages/09_Governed_Data_Corpus.md" || file == "Stages/10_Tokenizer_Representation.md" ||
                                     file == "Stages/11_Trainable_Native_NLP_Core.md";
    ...
    return "{\"production_stages_implemented\":false,\"implemented_foundations\":3,\"remaining_production_specifications\":\"12-17\",\"claim_boundary\":\"explicit\"}";
}
